  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Find your next tech conference: polkadot,kusama,  etc'
        />
        <title>
          Find your next tech conference | polkadot and kusama more
        </title>
        <link
        ...
        <meta
          content='Confs.tech | List of tech conferences: polkadot, kusama'
          property='og:site_name'
        />
        <meta content='website' property='og:type' />
        <meta content='Confs.tech' property='og:title' />
        <meta content='https://dotinurdu.com/' property='og:url' />
        <meta
          content='Find your next tech conference: '
          property='og:description'
        />

        <meta name='twitter:card' content='summary_large_image' />
        <meta name='twitter:site' content='@ConfsTech' />
        <meta name='twitter:creator' content='@dotevent1' />
        <meta
          name='twitter:title'
